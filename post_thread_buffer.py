...
def main():
    ...
    if not os.environ.get("ANTHROPIC_API_KEY"):
        ...
        tweets = [
            'HR : We would like to move forward. The offer is ready.\n\nCandidate : Please send it over.\n\nHR sends the offer.\n\nCandidate : I think there is a mistake.\n\nHR : There is no mistake.\n\nCandidate : This is 40% below what the posting said.\n\nHR : The posting range is for senior profiles.\n\nCandidate : Your JD said 3-5 years. I have 4 years.\n\nHR : Yes but internally we calibrate differently.\n\nCandidate : After round 1 your team said I was exactly what you were looking for.\n\nHR : You are. We love your profile.\n\nCandidate : Then why is the offer Rs9 LPA for a role posted at Rs15-20?\n\nHR : Budget constraints.\n\nCandidate : When did the budget change?\n\nHR : (Silence)\n\nCandidate : I spent 3 weeks on this process.\nTook a day off for the in-person round.\nTurned down another interview to prioritize this.\n\nHR : We really do value your time.\n\nCandidate : Does the hiring manager know what you are offering?\n\nHR : The offer has been approved by him.\n\nCandidate : And he is okay offering Rs9 for a Rs15-20 role?\n\nHR : This is our best and final offer.\n\nCandidate : I decline.\n\nHR : Is there any flexibility on your end?\n\nCandidate : You just said it was your best and final offer.\n\nHR : (Silence)\n\nCandidate : Good luck with your search.\n\nNext day.\n\nHR : We would like to revise the offer.\n\nNew offer : Rs14 LPA.\n\nSame role. Same team. Same manager.\n\nThe budget that did not exist yesterday\nexisted the moment the candidate said no.',
        ]
    else:
